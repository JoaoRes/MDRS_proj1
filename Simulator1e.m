function [PL , APD , MPD , TT, APD64, APD110, APD1518] = Simulator1e(lambda,C,f,P)
% INPUT PARAMETERS:
...
DELAYS110= 0;
DELAYS1518= 0;
TRANSMITTEDPACKETS64= 0;
TRANSMITTEDPACKETS110= 0;
TRANSMITTEDPACKETS1518= 0;
...
APD64= 1000*DELAYS64/TRANSMITTEDPACKETS64;
APD110= 1000*DELAYS110/TRANSMITTEDPACKETS110;
APD1518= 1000*DELAYS1518/TRANSMITTEDPACKETS1518;
